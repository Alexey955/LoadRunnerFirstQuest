# 1 "d:\\users\\user\\documents\\vugen\\scripts\\uc00_first_quest_vasiliev\\\\combined_UC00_First_Quest_Vasiliev.c"
...
# 1 "d:\\users\\user\\documents\\vugen\\scripts\\uc00_first_quest_vasiliev\\\\combined_UC00_First_Quest_Vasiliev.c" 2
...
# 2 "d:\\users\\user\\documents\\vugen\\scripts\\uc00_first_quest_vasiliev\\\\combined_UC00_First_Quest_Vasiliev.c" 2
...
# 3 "d:\\users\\user\\documents\\vugen\\scripts\\uc00_first_quest_vasiliev\\\\combined_UC00_First_Quest_Vasiliev.c" 2
...
vuser_init()
{
	...
	lr_end_transaction("UC00_TR01_Login",2);

	return 0;
}
# 4 "d:\\users\\user\\documents\\vugen\\scripts\\uc00_first_quest_vasiliev\\\\combined_UC00_First_Quest_Vasiliev.c" 2
...
UC01_Find_Flight()
{
	...
	lr_end_transaction("UC01_TR01_Button_Flights",2);
	...
	lr_end_transaction("UC01_Fill_Find_Flight",2);
...
UCO3_Ordering()
{
	...
	lr_end_transaction("UC03_TR01_Pick_Flight",2);
	...
	lr_end_transaction("UC03_TR02_Fill_Payment_Details",2);
...
# 7 "d:\\users\\user\\documents\\vugen\\scripts\\uc00_first_quest_vasiliev\\\\combined_UC00_First_Quest_Vasiliev.c" 2
...
UC04_Cancel()
{
	...
	lr_end_transaction("UC04_TR01_Cancel_Order",2);
...
UC02_Check_After_Cancel()
{
	...
	lr_start_transaction("UCO2_TR02_Button_Itinerary");
	...
	lr_end_transaction("UCO2_TR02_Button_Itinerary",2);
...
vuser_end()
{
	...
	lr_end_transaction("UC00_TR02_Sign_off",2);
